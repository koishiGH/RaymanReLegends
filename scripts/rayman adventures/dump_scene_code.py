...
def ask_output_folder():
    ...
    root = tk.Tk()
    root.withdraw()
    folder = filedialog.askdirectory(title="Select output folder for Scene functions")
    return folder
...
def find_scene_functions():
    ...
    for func_ea in idautils.Functions():
        ...
        if "ITF::Scene::" in func_name or (demangled_name and "ITF::Scene::" in demangled_name):
